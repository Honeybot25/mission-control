...
CREATE INDEX IF NOT EXISTS idx_scheduled_tasks_pending_priority ON scheduled_tasks(status, priority, scheduled_for) 
...
DROP POLICY IF EXISTS "Allow full access to authenticated users" ON scheduled_tasks;
